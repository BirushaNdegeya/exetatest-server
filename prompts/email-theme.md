...
This is an Expo React Native app. All UI components must follow Material Design 3 (M3) guidelines exactly, using the React Native Paper library: https://reactnativepaper.com/

- Use a Material UI style across the entire Expo React Native app.
- Ensure core UI elements follow Material guidance, including:
  - buttons
  - bottom sheets
  - inputs
  - cards
  - navigation components
- Aim for a polished Google-app-like look and feel.
- Keep spacing, typography, color usage, and component behavior consistent with the official Material guidance.
...
{
"description": "TYPE: CUSTOM\nMaterial Theme Builder export 2026-05-28 02:17:10",
"seed": "#769CDF",
"coreColors": {
"primary": "#769CDF"
},
